...
namespace AutoBuildEntity.Common.Helper
{
    public static class NVelocityHelper
    {
        ...
        /// 初始化模板引擎
        /// </summary>
        public static string ProcessTemplate(string template, Dictionary<string, object> dicStru)
        {
            ...
            //路径
            templateEngine.SetProperty(RuntimeConstants.FILE_RESOURCE_LOADER_PATH, Path.Combine(Environment.CurrentDirectory, "Templates"));
